...
$message = $manager->sendVideoNote(
    new \PHPTCloud\TelegramApi\Argument\DataObject\SendVideoNoteArgument(
        chatId: $chatId,
        videoNote: new \PHPTCloud\TelegramApi\Argument\DataObject\LocalFileArgument(__DIR__.'/assets/video-min.mp4'),
