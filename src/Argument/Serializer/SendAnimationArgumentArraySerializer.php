...
class SendAnimationArgumentArraySerializer implements SendAnimationArgumentArraySerializerInterface
{
    ...
    public function serialize(SendAnimationArgumentInterface $argument): array
    {
        ...
        $data[TelegramApiFieldEnum::ANIMATION->value] = $argument->getAnimation();
